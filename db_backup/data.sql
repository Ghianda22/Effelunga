...
-- Started on 2021-02-16 23:57:45
...
--
-- TOC entry 3168 (class 0 OID 16779)
-- Dependencies: 203
...
--
-- TOC entry 3175 (class 0 OID 16834)
-- Dependencies: 210
...
--
-- TOC entry 3172 (class 0 OID 16811)
-- Dependencies: 207
...
--
-- TOC entry 3193 (class 0 OID 17192)
-- Dependencies: 228
...
--
-- TOC entry 3183 (class 0 OID 16958)
-- Dependencies: 218
-- Data for Name: dipendente; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.dipendente VALUES ('vale            ', 'valentina', 'lore', '2011-11-11', '3333      ', 'va@le.it', 'napoleone', 2000, 'milano', '2011-01-01', 1000.00, '1');
INSERT INTO public.dipendente VALUES ('mario           ', 'mario', 'rossi', '2012-12-12', '3333      ', 'ma@rio.it', 'bonaparte', 2000, 'roma', '2021-01-01', 800.00, '88');
INSERT INTO public.dipendente VALUES ('luigi           ', 'luigi', 'bianchi', '2011-11-11', '3333      ', 'lui@gi.it', 'giuseppe', 2000, 'milano', '2021-01-01', 800.00, '8');
INSERT INTO public.dipendente VALUES ('anto            ', 'antonella', 'verdi', '2010-10-10', '3333      ', 'an@to.it', 'cesare', 2000, 'monza', '2000-01-01', 1500.00, '5');
INSERT INTO public.dipendente VALUES ('fede            ', 'federica', 'neri', '2012-12-12', '3333      ', 'fe@de.it', 'achille', 2000, 'monza', '2000-01-01', 1800.00, '1');
INSERT INTO public.dipendente VALUES ('elisa           ', 'elisa', 'puopolo', '2010-10-10', '3333      ', 'eli@sa.it', 'garibaldi', 2000, 'milano', '2011-01-01', 1000.00, '1');


--
-- TOC entry 3186 (class 0 OID 17014)
-- Dependencies: 221
...
--
-- TOC entry 3187 (class 0 OID 17019)
-- Dependencies: 222
...
--
-- TOC entry 3185 (class 0 OID 16984)
-- Dependencies: 220
...
--
-- TOC entry 3184 (class 0 OID 16966)
-- Dependencies: 219
...
--
-- TOC entry 3189 (class 0 OID 17065)
-- Dependencies: 224
...
--
-- TOC entry 3178 (class 0 OID 16889)
-- Dependencies: 213
...
--
-- TOC entry 3188 (class 0 OID 17050)
-- Dependencies: 223
...
--
-- TOC entry 3174 (class 0 OID 16828)
-- Dependencies: 209
...
--
-- TOC entry 3169 (class 0 OID 16785)
-- Dependencies: 204
...
--
-- TOC entry 3191 (class 0 OID 17088)
-- Dependencies: 226
...
--
-- TOC entry 3171 (class 0 OID 16802)
-- Dependencies: 206
...
--
-- TOC entry 3177 (class 0 OID 16864)
-- Dependencies: 212
...
--
-- TOC entry 3190 (class 0 OID 17075)
-- Dependencies: 225
...
--
-- TOC entry 3182 (class 0 OID 16917)
-- Dependencies: 217
...
--
-- TOC entry 3166 (class 0 OID 16768)
-- Dependencies: 201
...
--
-- TOC entry 3180 (class 0 OID 16906)
-- Dependencies: 215
...
--
-- TOC entry 3192 (class 0 OID 17103)
-- Dependencies: 227
...
-- Completed on 2021-02-16 23:57:46
