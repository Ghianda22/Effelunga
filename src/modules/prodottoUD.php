...
if(array_key_exists('mod',$_POST)){
    ...
    $cond = "id_prodotto = ".$data['row']['id_prodotto'];  // QUI DEVI CAMBIARE LA CONDIZIONE
    $_SESSION['cond'] = $cond;
    ...
    ?>
    <div>
        <p>Eliminando questo prodotto verranno eliminati anche tutti i prodotti composti ad esso correlati</p>
