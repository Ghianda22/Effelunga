...
if(array_key_exists('mod',$_POST)){
    ...
    $cond = "id_supermercato = '".$data['row']['id_supermercato']."' AND nome_reparto = '".$data['row']['nome_reparto']."' AND cf = '".$data['row']['cf']."' ";  // QUI DEVI CAMBIARE LA CONDIZIONE
    $_SESSION['cond'] = $cond;
    ...
    ?>
    <div>
        <p>Stai per eliminare la mansione attuale.</p>                         <!-- QUI DEVI CAMBIARE LA SCRITTA-->
