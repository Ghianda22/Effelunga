...
if(array_key_exists('mod',$_POST)){
    ...
    $cond = "id_supermercato = '".$data['row']['id_supermercato']."' AND id_prodotto = '".$data['row']['id_prodotto']."' ";  // QUI DEVI CAMBIARE LA CONDIZIONE
    $_SESSION['cond'] = $cond;
    ...
    ?>
    <div>
        <p>Stai per eliminare un prodotto in questo magazzino.</p>
