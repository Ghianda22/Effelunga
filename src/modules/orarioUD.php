...
if(array_key_exists('mod',$_POST)){
    ...
    $cond = "id_supermercato = '".$data['row']['id_supermercato']."' AND giorno = '".$data['row']['giorno']."' ";  // QUI DEVI CAMBIARE LA CONDIZIONE
    $_SESSION['cond'] = $cond;
    ...
    ?>
    <div>
        <p>Stai per eliminare l'orario.</p>                         <!-- QUI DEVI CAMBIARE LA SCRITTA-->
