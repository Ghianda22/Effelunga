...
if(array_key_exists('mod',$_POST)){
    ...
    $cond = "id_supermercato = '".$data['row']['id_supermercato']."' AND nome_reparto = '".$data['row']['nome_reparto']."' ";  // QUI DEVI CAMBIARE LA CONDIZIONE
    $_SESSION['cond'] = $cond;
    ...
    ?>
    <div>
        <p>Stai per eliminare il responsabile.</p>                         <!-- QUI DEVI CAMBIARE LA SCRITTA-->
